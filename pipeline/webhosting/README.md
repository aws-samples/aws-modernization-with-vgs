...
aws cloudformation create-stack --stack-name aws-modernization-with-vgs --template-body file://cloudfront-s3-website.yaml --enable-termination-protection
```
...
```
### DO NOT FORGET TO CHANGE THE STACK NAME
aws cloudformation create-stack --stack-name aws-modernization-with-vgs-Pipeline --template-body file://pipeline.yaml --capabilities CAPABILITY_NAMED_IAM --enable-termination-protection
```
